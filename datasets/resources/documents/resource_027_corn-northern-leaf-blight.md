...
{
  "id": "resource_027",
  "source_url": "https://cropprotectionnetwork.org/publications/an-overview-of-northern-corn-leaf-blight",
  "final_url": "https://cropprotectionnetwork.org/publications/an-overview-of-northern-corn-leaf-blight",
  "labels": [
...
DOI: doi.org/10.31274/cpn-20230425-0
...
Figures 1, 2. Early lesions of northern corn leaf blight can be pale and have a water-soaked appearance on the lesion edges.

Figure 1: Trey Price; Figure 2: Kiersten Wise

Figure 3A and B. Mature lesions of northern corn leaf blight on a susceptible hybrid.

Figure 3A: Trey Price; Figure 3B: Kiersten Wise

Figure 4. Fungal spores in the center of a mature lesion of northern corn leaf blight.

Gary Bergstrom

Figure 5. Severe NCLB can cause extensive blighting of leaf tissue.

Trey Price

Figure 6. Lesions of northern corn leaf blight on hybrids with race-specific resistance.
...
Figure 7. Spores of the fungus that causes northern corn leaf blight viewed in a lesion.
...
Figure 11. Hybrid with partial resistance (left) compared to a hybrid that is susceptible to northern corn leaf blight.
...
How to cite: Wise, K., Bergstrom, G., Price, T., Robertson, A., Tenuta, A. 2023. An Overview of Northern Corn Leaf Blight. Crop Protection Network. CPN-2022. doi.org/10.31274/cpn-20230425-0.

Click the link below to access the CCA CEU quiz.

An Overview of Northern Corn Leaf Blight [CCA CEU Quiz]
...
### An Overview of Goss's Bacterial Wilt and Blight (Archived)
